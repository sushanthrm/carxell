    ...
    <div className="flex-grow flex flex-col md:flex-row w-full min-h-screen">
      ...
      <div className="md:w-[70%] w-full flex items-center justify-center p-6 lg:p-12 relative bg-slate-900">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <h2 className="text-3xl font-black text-white mb-2 tracking-wide uppercase">Create Account</h2>
          <p className="text-slate-400 font-medium mb-8 text-lg">Register to access premium features.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="label text-xs font-bold text-slate-400">FULL NAME *</label>
              <input 
                type="text" 
          ...
          <div className="mt-12 pt-8 border-t border-white/10 text-center">
            <p className="text-slate-400 font-medium text-base">
              Already have an account? <Link to="/login" className="text-primary font-bold hover:text-primary-light hover:underline transition-all ml-2">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
