  ...
  return (
    <div className="flex justify-center items-center mt-10 px-4">
      <div className="glass-panel p-8 w-full max-w-md shadow-lg border-t-4 border-t-primary">
        ...
        <h2 className="text-2xl font-black text-slate-800 text-center mb-6 tracking-wide uppercase">Create an Account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="btn-primary w-full mt-2 hidden sm:block">Sign Up</button>
          <button type="submit" className="btn-primary w-full mt-2 sm:hidden">Sign Up</button>
        </form>
